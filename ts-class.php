...
$content.='<div id="slide'.$i.'" class="ts-slide-item">
                ...
                <p class="class="ts-slide-text" id="afterheadline">'.$updatedcontent.'</p></div>';
$i++;
endforeach;
$content.='</div></div>';
print $content;
...
add_action('wp_footer','ts_add_inline_js');
...
$ts_speed=get_option('ts_speed');
if($ts_speed==''){$ts_speed='2000';}
